...
<TR>
<TH colspan=2> Report on Rebates given & Compile Allowed Rebate Claim
<B><input type="hidden" name="1,0,0,Report on Rebates given & Compile Allowed Rebate Claim" value="R">
</B>
<TR>
...
<TR>
<TD CLASS="mm"><B>Enter the claim number for the year 00:</B>
<TD CLASS="mm"><input type="text" name="C2,0,0,Enter the claim number for the year 00:" value="<%=parms(1)%>" align="LEFT" size="10" maxlength="10">

<TR>
<TR>
<TD CLASS="mm"><B>Enter the PRS Shire No:</B>
<TD CLASS="mm"><input type="text" name="C3,0,0,Enter the PRS Shire No:" value="<%=parms(2)%>" align="LEFT" size="10" maxlength="10">
<TR>
...
if validated = "1" then
   ...
   result = d3.execute_tcl(session("logentry"),"TA1653",Cstr("PROSPECT" & chr(254) & sentence & chr(254) & after & "END" & chr(254) & ""))

...
<TR>
<TD CLASS="mm"><B>Display Rate Model</B>
<td><select name="3,0,0,Sorts">
<OPTION VALUE="1">By Rateable Code
<OPTION VALUE="2">By Zone
<OPTION VALUE="3">By Present Usage
<OPTION VALUE="4">By Ward
</select>

<TR>
<TD CLASS="mm"><B>Charging Category</B>
<td><select name="4,0,0,Category">
<%
For i = 1 to nocds

...
<TR>
<TD CLASS="mm"><B>Deposits FROM date</B>
<TD><input type="Text" name="C1,0,0,Deposits FROM date,,D2" value="<%=parms(0)%>" align="LEFT" size="10" maxlength="10">

<TR>
<TD CLASS="mm"><B>Deposits TO date</B>
<TD><input type="Text" name="C2,0,0,Deposits TO date,,D2" value="<%=parms(1)%>" align="LEFT" size="10" maxlength="10">

...
%>
<TITLE>Prospect 305 Log In</TITLE>
...
<%
parameters=Request.cookies("TA305")("parms")
parms=split(parameters,chr(8))
redim preserve parms(10)
dim wshnetwork
Set WshNetwork = CreateObject("Wscript.Network")
Set oPrinters = WshNetwork.EnumPrinterConnections
for k=0 to oprinters.count-1
   response.write("====" & k & "+" & oPrinters.Item(k) & "=====")
next
...
<TD><input type="Text" name="C1,0,0,Deposit Number" value="<%=parms(0)%>" align="LEFT" size="10" maxlength="10">

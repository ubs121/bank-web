...
items = picklin.get_dropdown(session("logentry"), "select distinct batch from inv_batch order by batch", mdb_name)
%>
...
'response.end
   ...
   result= cka_ta31.TA2480(session("logentry"), Server.MapPath("\prospect\template\"), mdb_name, cstr(after), "I")

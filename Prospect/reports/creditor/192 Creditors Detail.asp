...
<%
parameters=Request.cookies("TA192")("parms")
...
<TR>
<TD CLASS="mm"><B>G/L Dates</b>
<TD><input type="radio" name="5,0,0,Date Selection" value="G" align="LEFT" size="10" maxlength="10" checked>

<TR>
<TD CLASS="mm"><B>Transaction Dates</b>
<TD><input type="radio" name="5,0,0,Date Selection" value="T" align="LEFT" size="10" maxlength="10">

<TR>
<TD CLASS="mm"><B>Print Paid Transactions (Y/N)?</B>
<TD><input type="Text" name="C6,0,0,Print Paid Transactions,,YN" value="<%=parms(5)%>" align="LEFT" size="10" maxlength="10">

<TR>
<TD CLASS="mm"><B>Transactions with Reference Similar to</B>
<TD><input type="Text" name="7,0,0,Transactions with Reference Similar to" value="<%=parms(6)%>" align="LEFT" size="10" maxlength="10">

<TR>
<TD CLASS="mm"><B>Print All Transaction Narratives (Y/N)?</B>
<TD><input type="Text" name="C8,0,0,Print All Transaction Narratives (Y/N),,YN" value="<%=parms(7)%>" align="LEFT" size="10" maxlength="10">

<TR>
<TD CLASS="mm"><B>Print All Transaction Posting Detail (Y/N)?</B>
<TD><input type="Text" name="C9,0,0,Print All Transaction Posting Detail,,YN" value="<%=parms(8)%>" align="LEFT" size="10" maxlength="10">

<TR>
<TD CLASS="mm"><B>Print Accounts with No Details (Y/N)?</B>
<TD><input type="Text" name="C10,0,0,Print Accounts with No Details,,YN" value="<%=parms(9)%>" align="LEFT" size="10" maxlength="10">

<TR>
<TD CLASS="mm"><B>New Page for Each Account (Y/N)?</B>
<TD><input type="Text" name="C11,0,0,New Page for Each Account,,YN" value="<%=parms(10)%>" align="LEFT" size="10" maxlength="10">

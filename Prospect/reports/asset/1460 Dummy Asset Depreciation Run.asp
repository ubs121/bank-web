...
<%
parameters=Request.cookies("TA1460")("parms")
parms=split(parameters,chr(8))
redim preserve parms(10)
dates=picklin.make_options(session("logentry"), "MEASSET", "8|7|33",cstr(parms(0)))
dim sort(4)
...
<TR>
<TD CLASS="mm"><B>Do you want assets with no depreciation (Y/N)</B>
<TD><input type="Text" name="C2,0,0,Do you want assets with no depreciation (Y/N),,YN" value="<%=parms(1)%>" align="LEFT" size="10" maxlength="10">

<TR>
<TD CLASS="mm"><B>Summary Only (Y/N)</B>
<TD><input type="Text" name="C4,0,0,Summary Only (Y/N),,YN" value="<%=parms(3)%>" align="LEFT" size="10" maxlength="10">
</TR>
...
'response.end
   ...
   itemlist=cka_ta31.SR1455A(session("logentry"), 0, cstr(sentence), cstr(after))

...
<%
parameters=Request.cookies("TA1466")("parms")
...
<TR>
<TD CLASS="mm"><B>Depreciation date (must be month-end date)</B>
<TD><input type="Text" name="C1,0,0,Depreciation date (must be month-end date),,D2X" value="<%=parms(0)%>" align="LEFT" size="10" maxlength="10">

<TR>
<TR>
<TD CLASS="mm"><B>Depreciation YTD</b>
<TD><input type="radio" name="2,0,0,Depreciation" value="Y" align="LEFT" size="10" maxlength="10" checked>

<TR>
<TD CLASS="mm"><B>Depreciation This Month</b>
<TD><input type="radio" name="2,0,0,Depreciation" value="M" align="LEFT" size="10" maxlength="10">

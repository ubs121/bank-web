...
<TR>
<TD CLASS="mm"><B>Report only One deduction code</B>
<TD><input type="radio" name="5,0,0,One deduction code" value="o" align="LEFT" size="10" maxlength="10" checked >

<TR>
<TD CLASS="mm"><B>Enter the deduction code to report</B>
<TD><input type="text" name="C6,0,0,Enter deduction code" value="<%=parms(5)%>" align="LEFT" size="10" maxlength="10" checked >

<TR>
<TD CLASS="mm"><B>Print employee Surname and initials?</B>
<TD><input type="radio" name="7,0,0,Print employee Surname " value="S" align="LEFT" size="10" maxlength="10" checked>

<TR>
<TD CLASS="mm"><B>Print employee Full name and address?</B>
<TD><input type="radio" name="7,0,0,Print employee Surname " value="F" align="LEFT" size="10" maxlength="10">

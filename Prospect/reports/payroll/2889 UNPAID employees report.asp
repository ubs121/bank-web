...
<%
parameters=Request.cookies("TA2889")("parms")
...
<TR CLASS="top">
<TD class="mm" colspan=2><B>**NOTE** A Test Pay Run must have been run for this report to be successful. <b></b></b>
<BR><B>The report will contain employees NOT to be paid on the current Pay Date </b>
<TR CLASS="top" >

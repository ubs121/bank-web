...
<%
parameters=Request.cookies("TA2836")("parms")
...
<TR CLASS="top">
<TD  CLASS="mm"><B>Employee number or Blank for all</B>
<TD><input type="Text" name="1,0,0,Employee number or Blank for all" value="<%=parms(0)%>" align="LEFT" size="10" maxlength="10">
<TR>
...
<TD><input type="Text" name="3,0,0,Start Date (optional),,D2X" value="<%=parms(2)%>" align="LEFT" size="10" maxlength="10">

<TR>
<TD CLASS="mm"><B>End Date (optional)</B>
<TD><input type="Text" name="4,0,0,End Date (optional),,D2X" value="<%=parms(3)%>" align="LEFT" size="10" maxlength="10">

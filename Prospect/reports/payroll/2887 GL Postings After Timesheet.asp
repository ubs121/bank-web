...
<%
parameters=Request.cookies("TA2887")("parms")
...
<TR>
<TD CLASS="mm"><B></B>
<TD><input type="hidden" name="1,0,0,OK to continue" value="Y" align="LEFT" size="10" maxlength="10">

<TR>
<TD CLASS="mm" ><B>Pay type</B>
<TD class="mm">
<select name="2,0,0,Pay type">
<%
...
<TD><input type="Text" name="3,0,0,Pay Date,,D2X" value="<%=parms(2)%>" align="LEFT" size="10" maxlength="10">

<TR>
<TD CLASS="mm"><B></B>
<TD><input type="hidden" name="4,0,0,OK to continue" value="Y" align="LEFT" size="10" maxlength="10">

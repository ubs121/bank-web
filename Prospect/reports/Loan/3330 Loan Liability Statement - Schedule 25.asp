...
<TR>
<TD CLASS="mm"><B>For Year Ended</B>
<TD><input type="Text" name="C1,0,0,For Year Ended,,D2" value="<%=parms(0)%>" align="LEFT" size="10" maxlength="10">

<TR>
<TD CLASS="mm"><B>Do you wish to add loans issued after the year-ended chosen in the 'New Loans' column on the Report (Y/N)</B>
<TD><input type="Text" name="C2,0,0,Do you wish to add loans issued after the year-ended chosen in the 'New Loans' column on the Report (Y/N),,YN" value="<%=parms(1)%>" align="LEFT" size="10" maxlength="10">

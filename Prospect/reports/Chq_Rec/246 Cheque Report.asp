...
<%
parameters=Request.cookies("TA246")("parms")
...
<TR>
<TD CLASS="mm"><B>Start Date</B>
<TD><input type="Text" name="C1,0,0,Start Date,,D2X" value="<%=parms(0)%>" align="LEFT" size="10" maxlength="10">

<TR>
<TD CLASS="mm"><B>End Date</B>
<TD><input type="Text" name="C2,0,0,End Date,,D2X" value="<%=parms(1)%>" align="LEFT" size="10" maxlength="10">

...
<TD><input type="Text" name="C1,0,0,Start date,,D2" value="<%=parms(0)%>" align="LEFT" size="10" maxlength="10">

<TR>
<TD CLASS="mm"><B>End date</B>
<TD><input type="Text" name="C2,0,0,End date,,D2" value="<%=parms(1)%>" align="LEFT" size="10" maxlength="10">

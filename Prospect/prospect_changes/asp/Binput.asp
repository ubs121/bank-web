...
result = Picklin.make_html_item(Server.MapPath("\prospect\template\"),Session("logentry"),CStr(how), cstr(filetouse), cstr(itemtoget), cstr(template), cstr(action),cstr(sentence),cstr(search),cstr(transfile),cstr(no_update_delete),cstr(mainfile),cstr(printdoc),cstr(mergefile),cstr(docname),cstr(defaulting))
...
<form Name="frmTop"> 
<DIV id="Top" STYLE="position: absolute; left: 10px; top: 10px; width: 790px; z-order: 12; visibility: visible">

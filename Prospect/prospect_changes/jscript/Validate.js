...
Sub Query_Click()
   ...
   new_page = "/prospect/asp/binput.asp?fn=" & fname &  "&fn1=" & trans_fname & "&tn=" & tname & "&mainfile=" & mainfile & "&item=" & prefix & new_item  & "&baditem=empty&blank=no&err=noerrors&found=yes&search=" & search & "&no_update_delete=" & no_update_delete & "&printdoc=" & printdoc & "&merge=" & mergefile  & "&docname=" & docname  & "&defaulting=" & defaulting

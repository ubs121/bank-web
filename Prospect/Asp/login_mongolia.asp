...
<tr class=top><th  align="CENTER" valign="MIDDLE" colspan=2>PROSPECT LOG ON / Нэвтрэх
...
<tr class=top>
   <td colspan=2 align=center><INPUT TYPE=radio NAME=language VALUE="">English
   <INPUT TYPE=radio NAME=language VALUE="_mongolia" checked>Монгол
<%end if%>  

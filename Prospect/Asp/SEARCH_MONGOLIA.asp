...
Redim rname(0)
   ...
   srchkey = "1"
   extended=""
   the_drive = Server.MapPath("\prospect\template\")
   the_drive = Left(the_drive, InStr(1,the_drive, "\prospect\",1) - 1) & "\"
      ...
      DO WHILE NOT SessionTextFile.AtEndofstream
       ...
       select case temp
	    case "database"
          ...
          case "where": where=replace(mid(textline,pos+1),"@@PATH@@",the_drive)
...
<TR class=top>    
      ...
      <TD ALIGN=CENTER colspan=2>
        <FONT ><B>Хайх шинжїїр</B></FONT>
      <TD ALIGN=CENTER>
        <FONT ><B>Эрэмбэлэх</B></FONT> 
      <TD ALIGN=CENTER colspan=2>
        <FONT ><B>Талбаруудыг їзїїл</B></FONT>
<TR class=top>     
     <TD align=center>
         <INPUT type="button" class="smallButt" name ="Clear" value="Бїгдийг цэвэрлэ">
     <TD colspan=2 align=center>
         <INPUT type="button" class="smallButt" name ="Clear_search" value="Хайлтыг цэвэрлэ">
     <TD align=center>
         <INPUT type=button name ="Clear_sort" value="Эрэмбэлэлтийг цэвэрлэ">
     <TD colspan=2 align=center>
         <INPUT type=button name ="Clear_select" value="Талбаруудыг цэвэрлэ">
...
<%else%>
<TR class=top>
<TD colspan=4><FONT size=+2 ><B> Мэдээлэх </B></FONT>
...
<TD ALIGN=center colspan=2><INPUT TYPE="button" class=smallButt name="Search" value="Хай" OnClick='search_click("search")'>
</TABLE>
<%end if%>

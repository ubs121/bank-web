...
<TR>
   <TD CLASS="mm"><B>Principal G/L Asset Account</B>
...
<TR> 
    <TD CLASS="mm"><B>GST Exempt Code</B> 
    <TD> <INPUT type="Text" name="C3,0,0,GST Exempt Code" value="<%=crec(2)%>"  size="35"> 
<TR> 
    <TD CLASS="mm"><B>Invoice Prefix</B> 
    <TD> <INPUT type="Text" name="C4,0,0,Invoice Prefix" value="<%=crec(3)%>"  size="35"> 
<TR> 
    <TD CLASS="mm"><B>Interest Rate %</B> 
    <TD><INPUT type="Text" name="C5,0,0,Interest Rate %,,MD2" value="<%=formatnumber(crec(4)/100,2)%>"  size="35"> 
<TR> 
    <TD CLASS="mm"><B>Debtors Control Category for Loans Debtors</B> 
    <TD><INPUT type="Text" name="C6,0,0,Debtors Control Category for Loans Debtors,,MD0" value="<%=crec(5)%>"  size="35"> 

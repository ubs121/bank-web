...
<input type="hidden" name="item" value="TRANS.INFO">
...
<input type="hidden" name="id" value="TRANS.INFO">
...
<TD><B>Debtor Control Accounts (attribute 14 in item TRANS.INFO in DICT TRANS.J)</B>
...
<TR>
   <TD CLASS="mm"><B>Control Account One</B>
...
<TR>
   <TD CLASS="mm"><B>Control Account Two</B>

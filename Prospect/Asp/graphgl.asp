...
<TABLE ALIGN="LEFT" WIDTH="100%" BORDER="1" CELLSPACING="0" CELLPADDING="0">
  <TR><TD>
<MMflash:bargraph id="sna3" width="360" height="300" label="Last Year (<%=lastyr%>)">
...
<%next%>
  ...
  <TD>
<MMflash:bargraph id="sna1" width="360" height="300" label="This Year (<%=thisyr%>)">
 <%for ctr= 0 to Ubound(budget)%>
...
<%next%>
  ...
  <TD>
<MMflash:bargraph id="sna2" width="360" height="300" label="Next Year (<%=nextyr%>)">
 <%for ctr= 0 to Ubound(budget)%>

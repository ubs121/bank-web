 var  parentLyr,displayLyr,gobackLyr,buttLyr,ulistLyr,loadingLyr,groupLyr;
 var toggle = true;
 var prev_name = null;
 var prev_index = null;
 var shut=0;
...
function ShowAll()
{
    ...
    displayLyr = document.all["displayLayer"].style;
...
parentArray[7] = new arrayValues(null);
parentArray[8] = new arrayValues(null);
visibilitySetup();}
//*********************************************************************************************
